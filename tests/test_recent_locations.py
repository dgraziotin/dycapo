...
class TestRecentLocations():
    ...
    def test_position(self):
        for i in range (0,10):
            ...
            self.rider.position = classes.Location(georss_point=utils.georss_point_from_coords(self.rider.position_lat, self.rider.position_lon),leaves=utils.nowplusminutes(1))
